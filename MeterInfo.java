...
public class MeterInfo extends JFrame implements ActionListener {
    ...
    MeterInfo(String meternumber){
        ...
        lblmeternumber.setBounds(100,80,100,19);
        p.add(lblmeternumber);
       
        JLabel lblname =new JLabel(meternumber);
        lblname.setBounds(240,80,100,20);
        p.add(lblname);
       
        
       
       JLabel lblmeterno =new JLabel("Meter Locationr");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== next){
            ...
            String days="30";
             ...
             String query= "insert into meter_information values('"+meter+"', '"+location+"', '"+type+"','"+code+"', '"+typebill+"', '"+days+"')";
