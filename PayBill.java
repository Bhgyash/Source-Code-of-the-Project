   ...
   PayBill(String meter){
     ...
     labelunits.setBounds(300,260,200,20);
       add(labelunits);
        ...
        JLabel lbltotalbills=new JLabel("Total Bill");
        lbltotalbills.setBounds(35,320,200,20);
       add( lbltotalbills);
       
       JLabel labeltotalbills=new JLabel("");
     labeltotalbills.setBounds(300,320,200,20);
       add(labeltotalbills);
       
        JLabel lblstatus=new JLabel("Stauts");
